...
<head>
	...
	<link rel="stylesheet" href="css/regform4.css">
	...
	<header class="text-center">
		<div class="container">
			<div class="row">
				...
				<h3>EOI APPLICATION FORM step 4 </h3>
			</div>
			<!-- end of the /.row -->
		</div>
			...
			<div class="row">
				<form action="">
					...
					<div class="form-group business-operation">
						<label for="">9. Describe the potential of proposed Business to be financed by EEF: (Within Maximum 100 words in each section)</label>
						<div class="col-lg-12">
							<div class="form-group form-row">
								<label for="">9.1. Competitors</label>
...
<div class="clearfix"></div>
							<div class="form-group form-row">
								<label for="">9.2. Customer Value Proposition</label>
...
<div class="clearfix"></div> -->
							<div class="form-group form-row">
								...
								<div class="form-group col-lg-6 business-partner business-ex">
									<label for="">9.3. Business Partners</label>
								...
								<div class="form-group col-lg-6 business-partner">
									<label for="">9.4. Intellectual Property (Describe if any item below is applicable)</label>
									<select name="" id="" class="form-control">
...
<div class="clearfix"></div>
							<div class="form-group financial">
								<label for="">9.5. Financials</label>
								<div class="form-group">
									<div class="col-lg-4">
										<label for="">9.5a. Sales for the projected 3 years</label>
										<input type="text" name="" id="" class="form-control col-lg-4" placeholder="Sales for the projected 3 years" required>
									</div>
									<div class="col-lg-4">
										<label for="">9.5b. Profit for the projected 3 years</label>
										<input type="text" name="" id="" class="form-control col-lg-4" placeholder="Profit for the projected 3 years" required>
									</div>
									<div class="col-lg-4">
										<label for="">9.5c. Receivables position for the Projected 3 years</label>
										<input type="text" name="" id="" class="form-control col-lg-4" placeholder="Receivables position for the projected 3 years" required>
									</div>									
								</div>
								<!-- end of the /.form-group -->
								...
								<div class="form-group">
									<div class="col-lg-6">
										<label for="">9.5d. Total borrowing for the projected 3 years</label>
									...
									<div class="col-lg-6">
										<label for="">9.5e. Capital position for the projected 3 years</label>
